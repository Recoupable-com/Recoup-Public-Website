...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Recoupable collects, uses, and protects your personal information. Our comprehensive privacy policy covers data collection, cookies, and your rights.",
  openGraph: {
    title: "Privacy Policy | Recoupable",
    description:
      "Learn how Recoupable collects, uses, and protects your personal information.",
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                to enhance your experience on our website and analyze usage
                patterns.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                We do not transfer or disclose <strong>Google user data</strong>{" "}
                to third parties for purposes other than those described in this
                Privacy Policy. Any access, use, or sharing of Google user data
                is strictly limited to providing and improving our services,
                fulfilling obligations required by law, or actions that you have
                explicitly authorized. We do not use Google user data for
                advertising, profiling, or any other unrelated purposes.
              </p>
              ...
              <p className="text-gray-700 mb-4">
                Our website integrates with third-party services that may
