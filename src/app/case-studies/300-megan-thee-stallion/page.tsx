...
const timeline = [
  ...
  },
  {
    ...
    metrics: ["Email value: $82,560", "2,150 super fans identified"]
  },
  {
    date: "Day 3",
    title: "Peak Performance",
    description: "Campaign reached maximum efficiency",
    metrics: ["3,100 playlists created", "3,076 Spotify followers gained"]
  },
  {
    date: "Day 4",
    title: "Campaign Success",
    description: "Exceeded all target metrics",
    metrics: ["Total value: $206,400", "6,450 super fans identified"]
  }
];

export default function MeganTheeStallionCaseStudy() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden mb-12">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500/90 to-emerald-700/90 mix-blend-multiply" />
              <Image
                src="/artists/megan-thee-stallion-prime-doc.webp"
              ...
              >
                ...
                <div className="bg-red-50 rounded-xl p-8">
                  <p className="text-gray-900 mb-6 text-lg">
                    300 Entertainment needed a way to:
                  </p>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">Convert social media followers into actionable fan data</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-red-100 flex items-center justify-center">
                        <span className="block w-2 h-2 rounded-full bg-red-500" />
                      </span>
                      <span className="text-gray-700">Identify and engage super fans for targeted marketing</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-red-100 flex items-center justify-center">
                        <span className="block w-2 h-2 rounded-full bg-red-500" />
                      </span>
                      <span className="text-gray-700">Drive measurable ROI from fan engagement</span>
                    </li>
                  </ul>
                </div>
              </motion.section>
                ...
                <div className="space-y-6">
                  {timeline.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="absolute left-0 top-[6px] w-8 h-8 rounded-full bg-green-100 flex items-center justify-center">
                        <span className="block w-3 h-3 rounded-full bg-green-500" />
                      </div>
                      <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <div className="flex items-center gap-3 mb-3">
                          <span className="text-sm font-medium text-green-600">{item.date}</span>
