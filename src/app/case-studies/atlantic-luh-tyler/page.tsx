...
const timeline = [
  {
    ...
    description: "Launched fan engagement campaign with AI-powered targeting",
    metrics: ["22,044 fan data points collected", "3,001 game plays"]
  },
  {
    date: "Day 2",
    title: "Early Results",
    description: "AI optimization kicked in based on Day 1 data",
    metrics: ["Email value: $12,560", "1,850 super fans identified"]
  },
  {
    date: "Day 3",
    title: "Peak Performance",
    description: "Campaign reached maximum efficiency",
    metrics: ["2,100 playlists created", "2,076 Spotify followers gained"]
  },
  {
    date: "Day 4",
    title: "Campaign Success",
    description: "Exceeded all target metrics",
    metrics: ["Total value: $30,030", "ROI: +200%"]
  }
];

export default function LuhTylerCaseStudy() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden mb-12">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/90 to-indigo-700/90 mix-blend-multiply" />
              <Image
                src="/artists/luh-tyler-profile.webp"
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-white max-w-3xl p-8">
                  <h1 className="text-4xl md:text-6xl font-bold mb-6">
                    Emerging Artist Campaign Generated $30,030 in Value
                  </h1>
                  <p className="text-xl md:text-2xl text-white/90">
                    How Atlantic Records used Recoupable's AI to drive significant fan engagement for emerging artist Luh Tyler.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="bg-blue-50 rounded-xl p-8">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">Build momentum for an emerging artist</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center">
                        <span className="block w-2 h-2 rounded-full bg-blue-500" />
                      </span>
                      <span className="text-gray-700">Create a strong initial fan base</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center">
                        <span className="block w-2 h-2 rounded-full bg-blue-500" />
                      </span>
                      <span className="text-gray-700">Maximize early-stage marketing ROI</span>
                    </li>
                  </ul>
                </div>
              </motion.section>
                ...
                <div className="space-y-6">
                  {timeline.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="absolute left-0 top-[6px] w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
          ...
          >
            <div className="bg-black text-white rounded-2xl px-8 py-12">
              ...
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Join Atlantic Records and other major labels using Recoupable's AI to drive measurable results.
              </p>
